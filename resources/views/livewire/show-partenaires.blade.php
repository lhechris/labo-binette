<div >
    ...
    <div class="grid grid-cols-1 gap-10 md:px-50 px-4">
        ...
        <div class="flex gap-4">    
            <div class="max-w-32 min-w-32"><img src="{{ asset('storage/'.$item->image) }}" ></div>
            <div >{{ $item->content }} </div>
        </div>
        @endforeach
    </div>
    <div class="grid md:grid-cols-6 l grid-cols-3 gap-4 md:px-50 px-4 pt-8">
    ...
    <div class="grid md:grid-cols-6 grid-cols-3 gap-4 md:px-50 px-4">
